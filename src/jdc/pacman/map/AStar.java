...
public class AStar {
    ...
    public static List<Node> findPath(Map Map, Vector2i start, Vector2i end) {
        ...
        while (openList.size() > 0) {
            ...
            for (int i = 0; i < 9; i++) {
                ...
                Tile tile = Map.getTiles()[x + xi + ((y + yi) * Map.WIDTH)];
                if (tile == null) continue;
                if (tile instanceof WallTile) continue;
                if (i == 0) {
                    Tile test = Map.getTiles()[x + xi + 1 + ((y + yi) * Map.WIDTH)];
                    Tile test2 = Map.getTiles()[x + xi + ((y + yi + 1) * Map.WIDTH)];
                    ...
                    Tile test = Map.getTiles()[x + xi + ((y + yi - 1) * Map.WIDTH)];
                    Tile test2 = Map.getTiles()[x + xi + 1 + ((y + yi) * Map.WIDTH)];
